...
export const metadata: Metadata = {
	...
	authors: [{ name: 'Sanjay Bhati' }],
	creator: 'Sanjay Bhati',
	openGraph: {
		title: 'Sanjay Bhati - Developer Portfolio',
		...
		siteName: 'Sanjay Bhati - Portfolio',
		images: [
			{
				url: '/og-image.jpg',
				width: 1200,
				height: 630,
				alt: 'Sanjay Bhati - Developer Portfolio',
			},
		],
		locale: 'en_US',
		type: 'website',
